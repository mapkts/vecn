...
//! # Additional Notes
//!
//! `#[vector]` will automatically derive [`Copy`], [`Clone`] and [`PartialEq`] traits for the
//! annotated struct for convenience. Many methods rely on these properties to functionally work.
//! If you want to derive more traits for a vector type, put them below the `#[vector]` attribute
//! (otherwise the compiler will yell at you), like so:
//!
//! ```rust
//! # use vecn::vector;
//! #[vector]
